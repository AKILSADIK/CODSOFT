          ...
          <div className="flex justify-around w-[75%] ml-[1%] mt-[20px] items-center ">
            ...
            <div>
              <h1 className="text-1xl font-bold text-[#f24822]">
                Best Business Platform-World Record 2023
              </h1>
            </div>
          </div>
      ...
      <div className="flex   mt-6 w-[80%] m-auto h-[450px] text-white bg-[#2b304e]">
        ...
        <div className="mt-5 ml-20">
          ...
          <div className="flex mt-5 ">
            <div className="bg-[#ffffff] text-[black] rounded-full ... mt-3 mr-[10%]">
              <BsCheckCircle />
            </div>
            <div>
              <p className='text-1xl'>Cosmetic Forecast Marketing</p>
            </div>
          </div>
          ...
          <div className="flex   mt-5">
            <div className="bg-[#ffffff] text-[black] rounded-full ... mt-3 mr-[10%] mt-[-10000]">
        ...
        <div>
            <div className='grid grid-cols-4 gap-8 m-auto w-[70%] mt-10 '>
                ...
                <div className='p-3 w-[190px] rounded-lg ...   h-[230px] bg-[purple] shadow-md ...'>
                    ...
                    <div>
                    <p className='font-bold text-2xl text-center'>Design</p>

                    </div>
                    
                </div>
                <div className='w-[190px] rounded-lg ...   h-[230px] bg-[purple] shadow-md ...'>

                    <img className='h-[100px] m-auto' src="https://cdn.iconscout.com/icon/free/png-256/web-development-1876514-1588443.png" alt="/"/>

                    <div><p className='font-bold text-2xl text-center'>
                ...
                <div className=' w-[190px] rounded-lg ...   h-[230px] bg-[purple] shadow-md ...'>
                    ...
                    <img className='h-[100px] m-auto' src={back} alt="/"/>
                     ...
                     <div>
                        <p className='font-bold text-2xl text-center'>Back End Development</p>
                     </div>
                </div>
                ...
                <div className=' w-[190px] rounded-lg ...   h-[230px] bg-[purple] shadow-md ...'>
                    ...
                    <img className='h-[100px] m-auto' src={app} alt="/"/>
                      ...
                      <div>
                        <p className='font-bold text-2xl text-center'>Application Development</p>
                      </div>
                </div>
                ...
                <img className='h-[100px] m-auto' src="https://static.vecteezy.com/system/resources/previews/002/206/166/non_2x/cloud-computing-icon-free-vector.jpg" alt="/"/>
                 ...
                 <div>
                    <p className='font-bold text-2xl text-center'>Cloud Services</p>
                 </div>
                </div>
                ...
                <div>
                    <p className='font-bold text-2xl text-center'>Analytics</p>
                </div>
                </div>
                ...
                <img className='h-[100px] m-auto' src={qa} alt="/"/>
                     ...
                     <div>
                        <p className='font-bold text-2xl text-center'>Q-A and Testing</p>
                     </div>
                </div>
                ...
                <div><p className='font-bold text-2xl text-center'>Back Office Support</p></div>
                </div>
            </div>

            <div className='grid grid-cols-3 gap-8 m-auto w-[70%] mt-10 justify-content-center'>
                <div className='  h-[180px] shadow-md ...'>
                    <img className='h-[150px] m-auto' src={a} alt ="/"/>
                     
                     <p className='font-bold text-1xl text-center'>Cosmetic Forecast Marketing</p>
                </div>
                <div className=' h-[180px] shadow-md ...'>

                <img className='h-[150px] m-auto' src={b} alt="/"/>
                  <p className='font-bold text-1xl text-center'>Sales Analytics</p>
                </div>
                <div className=' h-[180px] shadow-md ...'>

                <img className='h-[150px] m-auto' src={c} alt="/"/>
                   <p className='font-bold text-1xl text-center'>Fashion Store Mobile Apps</p>
                </div>      

                <div className='h-[180px] shadow-md ... margin-right-10'>
                <img className='h-[150px] m-auto' src={d} alt="/"/>
                <p className='font-bold text-1xl text-center'>Laura's Clore Branding Identity</p>     
                </div>

                <div className='h-[180px] shadow-md ...'>
                  <img className='h-[150px] m-auto' src={e} alt="/"/>
                  <p className='font-bold text-1xl text-center'>SEO Marketing 4.0</p>
                </div>

                <div className='h-[180px] shadow-md ...'>
                  <img className='h-[150px] m-auto' src={f} alt="/"/>
                  <p className='font-bold text-1xl text-center'>Cloud Services</p>
                </div>
            </div>

            <div className="relative bg-blue-teal-gradient px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 text-center md:text-left">
              <div className="md:flex md:items-center md:justify-center">    
          <h2 className="text-xl font-bold text-white">Contact Us Through:
                  <br className="block md:hidden"/>
                </h2>
                <p>Where technology meets creativity</p>
                <a href="mailto:harikrishna.20it@sonatech.ac.in" className="px-8 py-4 bg-white text-blue-600 rounded inline-block font-semibold md:ml-8 mt-4 md:mt-0">Get Started</a>
              </div>
            </div>            
        </div>
      </div>
